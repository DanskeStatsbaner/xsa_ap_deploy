...
highlight("Log in to artifactory, pull and start docker_image")
...
highlight("Load and modify manifest.yml from deployment")
...
highlight("Define environment variables for deployment")
...
highlight("Create files for XSA application")
...
highlight("Deploy XSA application using XS CLI")
